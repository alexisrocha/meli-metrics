...
let metricData7 = {
  ...
  data:[{
    name: "Actual",
    data: [0.6248, 0.8230, 0.0588, 0.0746, 0.8782, 0.6770, 0.3858, 0.3427, 0.1180, 0.5491, 0.7098, 0.5964, 0.7426, 0.9132, 0.3791, 0.6753, 0.2000, 0.2149, 0.9988, 0.0981, 0.9052, 0.2776, 0.7619, 0.7529, 0.5690, 0.1372, 0.5143, 0.1558, 0.3285, 0.6109, 0.5516, 0.9634, 0.7664, 0.1541, 0.9264, 0.7952, 0.8950, 0.7599, 0.4551, 0.9898, 0.1385, 0.4303, 0.2618, 0.4538, 0.1838, 0.7606, 0.3750, 0.9098, 0.5653, 0.4471, 0.3565, 0.3866, 0.4735, 0.4093, 0.1740, 0.7368, 0.6923, 0.7535, 0.0571, 0.3732]
  },
  {
    name: "Last Year",
    data: [0.0237, 0.7566, 0.7169, 0.6620, 0.5315, 0.8934, 0.0793, 0.2042, 0.7774, 0.1807, 0.5683, 0.1114, 0.1782, 0.5802, 0.9627, 0.0994, 0.2232, 0.2615, 0.0703, 0.0440, 0.6066, 0.7709, 0.9367, 0.2787, 0.3275, 0.7457, 0.3622, 0.2483, 0.0276, 0.8702, 0.1545, 0.9317, 0.7541, 0.4447, 0.0601, 0.2216, 0.0558, 0.2848, 0.1644, 0.8930, 0.5297, 0.7997, 0.3167, 0.5448, 0.8260, 0.8839, 0.4333, 0.5567, 0.6584, 0.4304, 0.2118, 0.3493, 0.1832, 0.8168, 0.8904, 0.8919, 0.6666, 0.4105, 0.7218, 0.5568]
  }] 
}
// https://run.mocky.io/v3/a87e0162-954d-4c99-a0c3-6c7188f5baa0

let metricData8 ={
  labels: ["2020-03-1", "2020-03-2", "2020-03-3", "2020-03-4", "2020-03-5", "2020-03-6", "2020-03-7", "2020-03-8", "2020-03-9", "2020-03-10", "2020-03-11", "2020-03-12"],
  data:[{
    name: "Actual",
    data: [0.2792, 0.4797, 0.9733, 0.4792, 0.9827, 0.4447, 0.2272, 0.4479, 0.9269, 0.2976, 0.3451, 0.2038]
  },
  {
    name: "Last Year",
    data: [0.3110, 0.4022, 0.7496, 0.2995, 0.5107, 0.9626, 0.7950, 0.7233, 0.0213, 0.5740, 0.0148, 0.1790]
  }]
}
// https://run.mocky.io/v3/7ff3039b-0176-44e0-b018-11d14e4989b2

let metricData9 = {
  labels: ["2020-03-1", "2020-03-2", "2020-03-3", "2020-03-4"],
  data:[{
    name: "Actual",
    data: [0.6179, 0.7358, 0.9666, 0.2927]
  },
  {
    name: "Last Year",
    data: [0.0474, 0.8800, 0.5782, 0.3490]
  }]
}
// https://run.mocky.io/v3/0a842b8f-e515-4dfd-b45e-3e04008fcb4c